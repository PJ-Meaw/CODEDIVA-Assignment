                ...
                <div className="w-full flex flex-col items-center bg-[#f4f4f4] py-[40px] h-fit max-h-[30000px]">
                    ...
                    <div className="w-[480px] h-auto py-[40px] flex flex-col items-center gap-[16px] bg-white rounded-b-[10px]">
                        <div className="flex flex-col font-Kanit gap-[8px]">
                            ...
                            <input type="text" className="w-[400px] h-[48px] py-[4px] px-[11px] rounded-[10px] border border-[#d2d2d2] text-[14px] font-light outline-0" placeholder="กรอกอีเมล" onChange={(e) => setUsername(e.target.value)} />
                        </div>
                        <div className="flex flex-col font-Kanit gap-[8px]">
                        ...
                        <div className="w-[400px] flex flex-row justify-end">
                            <span className="text-[14px] text-[#e21c23] font-Kanit font-light">ลืมรหัสผ่าน</span>
                        </div>
                        <button className={`${((username.length != 0) && (password.length != 0)) ? "text-white bg-[#e21c23] " : "text-[#787878] bg-[#f4f4f4] cursor-not-allowed"} w-[400px] h-[48px] my-[8px] transition duration-500 text-[14px] font-Kanit  font-light rounded-[30px]`}>
                            เข้าสู่ระบบ
                        </button>
                    </div>
                </div>
